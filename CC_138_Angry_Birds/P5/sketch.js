...
function setup() {
  ...
  for (let i = 0; i < 3; i++) {
    boxes[i] = new Box(width - 300, (width / 3) - i * 75, 84, 100);
  }
  bird = new Bird(250, width / 3, 25);

  slingshot = new SlingShot(250, width / 3, bird.body);
...
function draw() {
  background(bkgImg, 0, 0, windowWidth, windowHeight);
